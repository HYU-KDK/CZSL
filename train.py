...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_prototypes",
        help="number of prototypes per primitive (CLUSPRO logic)",
        type=int,
        default=1
    )
    ...
    if torch.cuda.is_available():
        print(f"DEBUG: Using GPU {torch.cuda.current_device()} - {torch.cuda.get_device_name(0)}")
    ...
    elif hasattr(model, 'soft_embeddings_primitive'):
        print("soft embedding dtype", model.soft_embeddings_primitive.dtype)
